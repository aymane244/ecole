                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex">
                                        ...
                                        <select class="custom-select px-5" name="nameformation">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex">
                                        ...
                                        <input id="note" type="number" class="form-control px-5" min="0" max="20" name="note" value="" autocomplete="note" size="2" autofocus required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button type="submit" name="submit" class="btn btn-primary mx-3">Valider la note</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php
    if(isset($_POST['submit'])){
        $data->deleteNotes(@$_POST['note_id']);
    }
?>