    ...
    <body>
        <div class="div-background">
            <div class="container py-4">
                ...
                ?>
                <div class='alert alert-danger text-center' role='alert'><?php echo $_SESSION['error_login_admin']?></div>
                <?php
                ...
                ?>
                <div class='alert alert-success text-center' role='alert'><?php echo $_SESSION['success_admin']?></div>
                <?php
                ...
                ?>
                <div class='alert alert-success text-center' role='alert'><?php echo $_SESSION['success_password']?></div>
                <?php
