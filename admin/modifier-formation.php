                        ...
                        <div class="card card-position pb-5">
                            ...
                            <div class="card-body py-5">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="editor" rows="10" class="form-control" name="presentation" autocomplete="presentation" required><?php echo $presentation ?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="description" class="col-md-12 col-form-label text-md-end">Déscription</label>
                                    <div class="col-md-12">
                                        <textarea rows="10" id='editor2' class="form-control" name="description" autocomplete="description" value="<?php echo $description ?>"><?php echo $description ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
