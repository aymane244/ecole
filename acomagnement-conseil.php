...
<body>
    <div class="container" id="div-push">
        ...
        <div class="text-center my-3">
            <h2> Page Accompagenment & conseil</h2>
        </div>
        ...
        <div id="iso">
            <div class="mt-5 align-items-center text-center">
                <a href="ajouter-accompangement" target="_blank" class="btn btn-primary"><i class="fas fa-plus-square"></i> Ajouter un accompangement ISO</a>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="row-style">
                            <form action="" method="POST">
                                ...
                                <button type="submit" class="btn-style" name="submit_iso" onclick='return confirm("Voulez-vous supprimer cet élement")'>
        ...
        <div id="douane" style="display:none;">
            <div class="mt-5 align-items-center text-center">
                <a href="ajouter-categorisation" target="_blank" class="btn btn-primary"><i class="fas fa-plus-square"></i> Ajouter une catégorisation douane</a>
            </div>
            <!--<div class="mt-4 align-items-center">
                <a href="ajouter-article" target="_blank" class="btn btn-primary">
                    <i class="far fa-share-square"></i> Envoyer un email
                    ...
                    <tr>
                        ...
                        <td class="row-style">
                            <form action="" method="POST">
                                ...
                                <button type="submit" class="btn-style" name="submit_douane" onclick='return confirm("Voulez-vous supprimer cet élement")'>
                                    <i class="fas fa-trash-alt text-danger awesome-size"></i>
                                </button>
                            </form>
                        </td>
