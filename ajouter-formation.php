        ...
        <div class="row">
            <div class="col-md-12 my-5">
                <div class="card card-position">
                    <div class="card-header text-center link-font align-items-center"><i class="fas fa-plus-square"></i> Ajouter une formation</div>
                        <div class="card-body py-5 w-100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex">
                                        <textarea type="text" rows="10" class="form-control position-text-area pt-5" name="presentation" value="" autocomplete="presentation" autofocus required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div id="editor"></div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex">
                                        <i class="fas fa-arrows-alt position-awesome-cursor" id="sizerformation" onclick="fullpageformation()"></i>
                                        <textarea type="text" rows="10" class="form-control position-text-area pt-5" id="zone-textf" name="description" value="" autocomplete="presentation" autofocus required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-12">
                                    <button type="submit" name="submit" class="btn btn-primary mx-3">Ajouter la formation</button>
                                </div>
                            </div>
                        </form>
                    </div>
