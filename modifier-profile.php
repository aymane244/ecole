                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <input id="cin" type="text" class="form-control pl-5" name="cin" autocomplete="cin" value="<?php echo $cin?>" placeholder="Votre carte d'identité nationale" disabled>
                                            </div>
                                        </div>
                                    </div>  
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                <i class="fas fa-file-alt position-awesome"></i>
                                                <input id="age" type="text" class="form-control pl-5" name="age" autocomplete="age" value="<?php echo $age->format('%y');?> ans" placeholder="Votre carte d'identité nationale" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="d-flex">
                                                ...
                                                <input id="image" type="file" class="form-control-file pl-5" name="image" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-0">
