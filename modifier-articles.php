                        ...
                        <div class="card-body py-5">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex">
                                        <i class="fas fa-poll position-awesome"></i>
                                        <input id="art_titre_arab" type="text" class="form-control pl-5" name="art_titre_arab" value="<?php echo $titre_arab ?>" placeholder="عنوان المقال" autocomplete="titre" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
